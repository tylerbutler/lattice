...
pub fn new_creates_register_with_value_test() {
  lww_register.new("hello", 1, "test-replica")
  |> lww_register.value
  |> expect.to_equal("hello")
}

pub fn value_returns_current_value_test() {
  lww_register.new("world", 42, "test-replica")
  |> lww_register.value
...
pub fn set_keeps_value_when_timestamp_is_equal_test() {
  lww_register.new("hello", 5, "test-replica")
...
pub fn merge_returns_register_with_higher_timestamp_test() {
  let reg_ts1 = lww_register.new("first", 1, "A")
  let reg_ts2 = lww_register.new("second", 2, "B")
...
pub fn merge_tiebreak_uses_replica_id_test() {
  let reg_a = lww_register.new("aaa", 5, "A")
  let reg_b = lww_register.new("bbb", 5, "B")
...
pub fn merge_commutativity_on_different_timestamps_test() {
  let reg_a = lww_register.new("alpha", 10, "A")
  let reg_b = lww_register.new("beta", 20, "B")
